...
<div class="card-body">
<form method="post" id="userProfileForm" action="editprof.php">
...
<button class="btn-primary" id="editButton" type="submit" value="Edit">Edit</button>
</form>
</div>
</div>
</div>
...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        // Select the "Edit" button by its id
        const editButton = document.getElementById("editButton");

        // Add a click event listener to the "Edit" button
        editButton.addEventListener("click", function() {
            // Redirect to the "editprof.html" page
            window.location.href = "editprof.html";
        });
    });
